...
const HeroSection = () => {
  return (
    <section className="h-screen my-0 flex flex-col items-center justify-center ">
      <div className=" px-4 mx-auto max-w-screen-xl text-center lg:py-4 lg:px-12 flex flex-col items-center">
        ...
        <h1 className="mb-4 text-xl font-bold tracking-tight leading-none text-gray-400 md:text-xl lg:text-xl dark:text-gray-400">
          Hi, I am
        </h1>
        <TypeAnimation
          ...
          cursor={false}
        />
        <h1 className="mb-4 text-xl font-bold tracking-tight leading-none  text-gray-400 md:text-xl lg:text-xl">
